...
<a name="about"></a>
## About The App
`JukeBox` is an Open Source project brought to you by `Iot Lab,KIIT` and it brings you easy and optimized visuals for the explanation of the code. 
...
Refer to [issues](https://github.com/iot-lab-kiit/JukeBox/issues) for tasks.
